package lab.lhss.algasensor.device.management.api.config.web;

import lab.lhss.algasensor.device.management.api.client.SensorMonitoringClientBadGatewayException;
